...
The second, referred to as the **General Hydrostatic Stability Model**, preserves the same buoyancy calculation while allowing the vertical position of the center of gravity to be varied. Unlike the Ideal Hydrostatic Model, this implementation makes it possible to investigate how changes in the center-of-gravity location influence the righting arm, restoring moment, and equilibrium stability. Consequently, stable, neutral, and unstable equilibrium configurations can be explored interactively.
...
Together, the two MATLAB implementations establish the computational foundation for both the baseline hydrostatic model and its generalized extension. The computational framework described above is verified in the following section before being applied to the hydrostatic and dynamic simulations presented later in this chapter.
...
Figure 5. Numerically computed righting arm as a function of tilt angle.
